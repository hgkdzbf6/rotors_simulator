...
AttitudeControllerNode::AttitudeControllerNode() {
  ...
  cmd_pose_sub_ = nh.subscribe(
      ...
      &AttitudeControllerNode::CommandPoseCallback, this);
  ...
  command_timer_ = nh.createTimer(ros::Duration(0), &AttitudeControllerNode::TimedCommandCallback, this,
                                  true, false);
}
...
void AttitudeControllerNode::InitializeParams() {
  ...
  GetRosParameter(pnh, "position_gain/x",
                  attitude_controller_.controller_parameters_.position_gain_.x(),
                  &attitude_controller_.controller_parameters_.position_gain_.x());
  GetRosParameter(pnh, "position_gain/y",
                  attitude_controller_.controller_parameters_.position_gain_.y(),
                  &attitude_controller_.controller_parameters_.position_gain_.y());
  GetRosParameter(pnh, "position_gain/z",
                  attitude_controller_.controller_parameters_.position_gain_.z(),
                  &attitude_controller_.controller_parameters_.position_gain_.z());
  GetRosParameter(pnh, "velocity_gain/x",
                  attitude_controller_.controller_parameters_.velocity_gain_.x(),
                  &attitude_controller_.controller_parameters_.velocity_gain_.x());
  GetRosParameter(pnh, "velocity_gain/y",
                  attitude_controller_.controller_parameters_.velocity_gain_.y(),
                  &attitude_controller_.controller_parameters_.velocity_gain_.y());
  GetRosParameter(pnh, "velocity_gain/z",
                  attitude_controller_.controller_parameters_.velocity_gain_.z(),
                  &attitude_controller_.controller_parameters_.velocity_gain_.z());
  GetRosParameter(pnh, "attitude_gain/x",
                  attitude_controller_.controller_parameters_.attitude_gain_.x(),
                  &attitude_controller_.controller_parameters_.attitude_gain_.x());
  GetRosParameter(pnh, "attitude_gain/y",
                  attitude_controller_.controller_parameters_.attitude_gain_.y(),
                  &attitude_controller_.controller_parameters_.attitude_gain_.y());
  GetRosParameter(pnh, "attitude_gain/z",
                  attitude_controller_.controller_parameters_.attitude_gain_.z(),
                  &attitude_controller_.controller_parameters_.attitude_gain_.z());
  GetRosParameter(pnh, "angular_rate_gain/x",
                  attitude_controller_.controller_parameters_.angular_rate_gain_.x(),
                  &attitude_controller_.controller_parameters_.angular_rate_gain_.x());
  GetRosParameter(pnh, "angular_rate_gain/y",
                  attitude_controller_.controller_parameters_.angular_rate_gain_.y(),
                  &attitude_controller_.controller_parameters_.angular_rate_gain_.y());
  GetRosParameter(pnh, "angular_rate_gain/z",
                  attitude_controller_.controller_parameters_.angular_rate_gain_.z(),
                  &attitude_controller_.controller_parameters_.angular_rate_gain_.z());
  GetVehicleParameters(pnh, &attitude_controller_.vehicle_parameters_);
  attitude_controller_.InitializeParameters();
}
void AttitudeControllerNode::Publish() {
}

void AttitudeControllerNode::CommandPoseCallback(
  ...
  attitude_controller_.SetTrajectoryPoint(commands_.front());
  commands_.pop_front();
}
...
void AttitudeControllerNode::TimedCommandCallback(const ros::TimerEvent& e) {
...
void AttitudeControllerNode::OdometryCallback(const nav_msgs::OdometryConstPtr& odometry_msg) {
  ...
  attitude_controller_.SetOdometry(odometry);
